...
<html lang="pt-BR">
    ...
    <body>
        ...
        <header class="l-header" name="header">
            <nav class="nav bd-container">
                ...
                <div class="nav__menu" name="nav-menu">
                    <ul class="nav__list">
                        <li class="nav__item"><a href="#nav-menu" class="nav__link active-link">Home</a></li>
                        <li class="nav__item"><a href="#celulares" class="nav__link">Produtos</a></li>
        ...
        <main class="l-main">
            <section class="home" name="inicio">
            ...
            <section class="menu section bd-container" name="celulares">
            ...
            <div class="footer__container bd-grid">
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li><a href="#celulares" class="footer__link">Produtos</a></li>
                    </ul>
                </div>
